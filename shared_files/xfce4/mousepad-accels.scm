...
(gtk_accel_path "<Actions>/win.document.previous-tab" "<Primary><Shift>Tab")
...
(gtk_accel_path "<Actions>/win.file.detach-tab" "")
...
(gtk_accel_path "<Actions>/win.document.next-tab" "<Primary>Tab")
